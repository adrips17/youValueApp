...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\LugarType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\LugarType']) ? $this->services['AppBundle\Form\LugarType'] : $this->services['AppBundle\Form\LugarType'] = new \AppBundle\Form\LugarType()) && false ?: '_'};
